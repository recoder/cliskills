...
def test_demo_skill_commands_outputs_json() -> None:
    runner = CliRunner()
...
def test_demo_skill_commands_outputs_markdown() -> None:
    runner = CliRunner()
...
def test_demo_skill_commands_outputs_toon() -> None:
    runner = CliRunner()
...
def test_demo_skill_commands_rejects_unsupported_format() -> None:
    runner = CliRunner()
